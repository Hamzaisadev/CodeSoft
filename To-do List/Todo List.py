...
def delete_task():
  ...
  try:
    ...
    if the_task in task_list:
      ...
      CTkMessagebox.CTkMessagebox(title="error", message="Can't Delete!! select something to delete")
...
delete_task_btn = CTk.CTkButton(master=todo_list,height=35,
                             corner_radius=100,
                             font=("Helvetica", 15,"bold"), text="Delete Task", command=delete_task)

delete_task_btn.pack()
delete_task_btn.place(x=10, y=240)


next_day_btn =CTk.CTkButton(master=todo_list,height=35,
                             corner_radius=100,
                             font=("Helvetica", 15,"bold"), text="Next Day")

next_day_btn.pack()
next_day_btn.place(x=10, y=290)

exit_btn = CTk.CTkButton(master=todo_list, height=35,
                             corner_radius=100,
                             font=("Helvetica", 15,"bold"),text="Exit")
